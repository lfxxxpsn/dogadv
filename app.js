...
const scenes = {
  ...
  walk: {
    ...
    choices: [
      { text: "\u5148\u6478\u6478\u5979\uff0c\u518d\u6162\u6162\u51fa\u9580", affection: 1, next: "park" },
  ...
  park: {
    ...
    choices: [
      { text: "\u966a\u5979\u6162\u8d70\uff0c\u807d\u5979\u9f3b\u5b50\u88e1\u7684\u5c0f\u8072\u97ff", affection: 1, next: "play" },
  ...
  play: {
    ...
    choices: [
      ...
      { text: "\u4f60\u662f\u6211\u4eca\u5929\u7684\u7b2c\u4e00\u540d", affection: 2, next: "rest" },
    ],
  },
  rest: {
    label: "\u975c\u4e0b\u4f86",
  ...
  confess: {
    ...
    choices: [
      ...
      { text: "\u963f\u79cb\uff0c\u4f60\u9858\u610f\u628a\u4eca\u5929\u4e5f\u5206\u6211\u4e00\u534a\u55ce", affection: 2, next: "ending" },
    ],
  },
};
...
function showEnding() {
  const ending = state.affection >= 10 ? endings.best : state.affection >= 7 ? endings.good : endings.soft;
